...
num_of_rows_outliers = outliers.shape[0] # 42 outliers in new data
...
statistic, p_value = stats.shapiro(df['salary_23_24_log'])
...
print(salaries_raptor_darko['player'].head(30))
print(salaries_raptor_darko[['player', 'raptor_plus_darko']].head(20))
...
print(salaries_raptor_darko[['player', 'DARYL_SCORE']].head(20))
...
salaries_raptor_darko.to_csv('./data_given_to_front_end/nba_data.csv', index=False)
"""
...
plt.hist(salaries_raptor_darko['DPM'], bins = 20)

# Set labels and title
plt.xlabel('DARKO')
plt.ylabel('Frequency')
plt.title('DARKO Distribution Without Filtering Outliers')
